<div class="modal fade" data-backdrop="static" id="edit-item-modal" tabindex="-1" role="dialog" aria-labelledby="edit-item-modal" aria-hidden="true">
            ...
            <div class="modal-body p-0">
                <div class="card shadow border-0"> 
                    ...
                    <div class="card-body bg-secondary">
                        <form action="{{ route('items.update', $id) }}" method="POST" id="item-update-form" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="Qty" id="qty" name="qty" class="form-control form-control-alternative is-valid" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="" class="form-control-label">Image</label>
                                        <input type="file" class="form-control-file" id="new-item-image" name="new_image" id="new-item-image">
                                        <input type="text" name="image" id="image" hidden>
                                    </div>
                                </div>
                                <img src="" id="edit_item_img_url" alt="your image" width="100" height="100" class="pl-3">
                            </div>
                        </form>
                    </div>
