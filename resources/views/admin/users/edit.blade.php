<div class="modal fade" data-backdrop="static" id="edit-user-modal" tabindex="-1" role="dialog"
            ...
            <div class="modal-body p-0">
                <div class="card shadow border-0">
                    ...
                    <div class="card-body bg-secondary">
                        <form action="{{ route('admin.users.update', $id) }}" method="POST" id="edit-user-form"
                    ...
                    <div class="card-footer bg-secondary text-center px-lg-2 px-1">
                        <button type="submit" form="edit-user-form" class="btn btn-success text-white">Update</button>
                        <button type="button" id="edit-user-cancel-btn" class="btn btn-primary text-white"
