                    ...
                    @foreach ($data as $key => $item)
                        <tr>
                            ...
                            <td class="align-middle">
                                <span
                                    class="badge badge-{{ $item->public_status ? 'success' : 'light' }}">{{ $item->public_status ? 'On' : 'Off' }}</span>
                            </td>
                            <td class="align-middle">
                                <a href="javascript:;" class="font-weight-bold px-1 text-sm" data-id="{{ $item->id }}"
                                    data-policy_category_id="{{ $item->policy_category_id }}"
                                    data-header="{{ $item->header }}" data-description="{{ $item->description }}"
                                    data-public_status="{{ $item->public_status }}" data-toggle="modal"
                                    data-target="#edit-policy-modal">
