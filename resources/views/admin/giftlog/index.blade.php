    ...
    <div>
        <div class="d-flex justify-content-between content_detail_header">
            <div class="align-self-center">
                <form class="navbar-search navbar-search-light form-inline mr-sm-3" action="{{route('giftLog.index')}}">
                    <div class="form-group mb-0">
                        <div class="input-group input-group-alternative input-group-merge searching">
                            <input class="form-control searching" placeholder="Search by user name" type="text" name="user_name" value="{{request('user_name')}}">
                        </div>
                        <div class="input-group input-group-alternative input-group-merge searching gift-log-filter">
                            <input class="form-control searching" placeholder="Search by gift item" type="text" name="gift_item" value="{{request('gift_item')}}">
                        </div>
                        <div class="input-group input-group-alternative input-group-merge searching gift-log-filter">
                            <input class="form-control searching" placeholder="Search by gift box" type="text" name="gift_box" value="{{request('gift_box')}}">
                        </div>
            ...
            <table class="table align-items-center mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="text-sm font-weight-bold mb-0">{{optional(optional($item->giftItemBox)->giftItems)->name}}</p>
                        </td>
                        <td>
                            <p class="text-sm font-weight-bold mb-0">{{optional(optional($item->giftItemBox)->giftBoxes)->name}}</p>
                        </td>
