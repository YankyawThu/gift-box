...
<div>
    <div class="d-flex justify-content-between content_detail_header">
        <div class="align-self-center">
            <form class="navbar-search navbar-search-light form-inline mr-sm-3" action="{{route('admin.boxes.index')}}"
                ...
                <div class="form-group mb-0 category-filter">
                    <select class="form-select form-control form-control-alternative"
                        ...
                        <option value="{{$item->id}}" @if(request('category_id')==$item->id) selected
