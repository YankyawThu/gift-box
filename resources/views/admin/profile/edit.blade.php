...
@section('content')
@include('admin.admins.partials.header', [
'title' => __('Hello') . ' '. auth('admin')->user()->username,
'class' => 'col-lg-12'
])
                ...
                <div class="card-body pt-0 pt-md-4">
                    ...
                    <div class="text-center">
                        ...
                        <div class="h5 font-weight-300">
                            <i class="ni location_pin mr-2"></i> {{ auth('admin')->user()->nickname }}
                        </div>
                        <div class="h5 mt-4">
                            <i class="ni business_briefcase-24 mr-2"></i>{{ auth('admin')->user()->email }}
                        </div>
                        ...
                        <div class="pl-lg-4">
                            <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="name" id="input-name"
                                    ...
                                    placeholder="{{ __('Name') }}"
                                    value="{{ old('name', auth('admin')->user()->username) }}" required autofocus>
