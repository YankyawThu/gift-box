<template>
    <div class="h-screen">
        <main class="pb-20 px-4">
            <div class="flex justify-between pt-7 pb-4">
            ...
            <div id="tabs">
                ...
                <div class="my-2">
                    <section id="panel-pending" role="tabpanel" tabindex="0" aria-labelledby="tab-pending" class="overflow-auto">
                        <div class="flex justify-between my-4">
                            <div></div>
                            <div class="flex flex-row"><div><input type="checkbox" v-model="selectAll" class="w-5 h-5 mr-2"></div><div class="text-sm self-center">Select All</div></div>
                        </div>
                        <div v-for="(prize,i) in pending" :key="i" class="flex flex-row">
                    ...
                    <section id="panel-recycle" role="tabpanel" tabindex="0" aria-labelledby="tab-recycle" hidden class="overflow-auto">
